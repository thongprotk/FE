  ...
  const renderLinks = (className: string) => (
    <div className={className}>
      {links.map((link) => (
        ...
        >
          {link.label}
          {link.to === "/decks" && isAuthenticated && dueCount > 0 && (
            <span className="absolute -top-1 -right-1 min-w-4.5 h-4.5 px-1 text-[10px] font-bold leading-4.5 text-center bg-orange-500 text-white rounded-full">
